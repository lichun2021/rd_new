...
CREATE TABLE `commander` (
  ...
  `immortEcho` text COLLATE utf8mb4_unicode_ci,
  PRIMARY KEY (`playerId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `plant_science` (
  `id` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `playerId` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `plantScienceSerialized` text COLLATE utf8mb4_unicode_ci,
  `createTime` bigint(20) NOT NULL,
  `updateTime` bigint(20) NOT NULL,
  `invalid` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `player` (
  ...
  `factoryUpTime` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `push_gift` (
  ...
  `groupRefreshCount` text COLLATE utf8mb4_unicode_ci,
  `resetTime` bigint(20) NOT NULL DEFAULT '0',
  `createTime` bigint(20) NOT NULL DEFAULT '0',
  `updateTime` bigint(20) NOT NULL DEFAULT '0',
  `invalid` int(11) NOT NULL DEFAULT '0',
  ...
  `armourIntensifyTimes` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `armourStarUpTimes` text COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`playerId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- Dump completed on 2026-05-13 23:23:45
