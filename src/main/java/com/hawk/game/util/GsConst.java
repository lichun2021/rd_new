...
public class GsConst {
	...
	/** 一周的秒数 */
	public static final int WEEK_SECONDS = 86400 * 7;
	// 一个月的秒数
	...
	public static class ObjId {
		...
		/** 周年聚会 */
		public static final int ANNY_PARTY = 169;
		/** 先驱回响 赛季 */
		public static final int XQHX_SEASON = 170;
		/** 秘藏寻踪 */
		public static final int FIND_STORE_HOUSE = 171;
	}
	...
	public static class ModuleType {
        ...
        //周年聚会
        public static final int ANN7_PARTY = 136;
        //新人里程碑
        public static final int ROOKIE_MILESTONE = 137;

		//秘藏寻踪
		public static final int FIND_STORE_HOUSE = 138;
		// 账号模块
	...
	public static class BuildingConditionType {
		...
		public static final int ROOKIE_MILESTONE_PROGRESS = 5;       // 新人里程碑进度
	}
