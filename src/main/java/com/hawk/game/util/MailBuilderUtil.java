	...
	public static FightMail.Builder createFightMail(IBattleIncome battleIncome, BattleOutcome battleOutcome, boolean isAtk) {
		...
		if (players != null) {
			...
			for (Player player : players) {
				...
				EffectParams effectParams = isAtk ? battleIncome.getAtkPlayerEffectParams(player.getId()) : battleIncome.getDefPlayerEffectParams(player.getId());
				PBHeroRiseShow risePage = effectParams.getRisePage();
				if(risePage!=null){
					mailArmyBuilder.setRise(risePage);
				}
