...
public class EffectParams {
	...
	private PBHeroRiseShow risePage;
	...
	public PBHeroRiseShow getRisePage() {
		return risePage;
	}

	public void setRisePage(PBHeroRiseShow risePage) {
		this.risePage = risePage;
	}
