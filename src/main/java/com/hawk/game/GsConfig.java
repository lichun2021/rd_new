...
public class GsConfig extends HawkAppCfg {
	...
	/**跨服数据专用redis */
	protected final String crossReids;
	protected final String crossRedisAuth;
	/**
	 * redis超时时间
	 */
	...
	public GsConfig() {
		...
		serverSvnAddrs = "50001-svn://192.168.50.81/redalert/Resource_Product/trunk/0.配置表/2.后台/,"
				...
				+ "50003-svn://192.168.50.81/redalert/Resource_Product/milestone/1.4.109/0.配置表/2.后台/,"
	...
	public String getCrossReids() {
		return crossReids;
	}

	public String getCrossRedisAuth() {
		return crossRedisAuth;
	}
