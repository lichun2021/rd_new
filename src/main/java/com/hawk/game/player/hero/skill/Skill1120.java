...
public class Skill1120 extends ISSSHeroSkill {
	/**
	12841】
  - 【万分比】【12841】战技持续期间，自身出征数量最多的轰炸机受到攻击时，伤害减少 +XX.XX%【12841】
    - 战报相关
      - 于战报中展示
      - 不合并至精简战报中
    ...
    - 自身出征数量最多的轰炸机
      ...
      - 满足条件后，该作用号效果仅对玩家出征时数量最多的轰炸机（兵种类型 = 3）生效（若存在多个部队数量一样且最高，取等级高的）
	...
	public int effectTime() {
		return effectTime * 1000 + getSoulEffVal(EffType.HERO_12854) * 1000;
	}
