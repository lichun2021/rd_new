...
public class PlayerHero {
	...
	public int power() {
		...
		return (int) (heropow + starPow + skillpow + skinPow + talentPow + soul.power() + rise.getPower());
	}
	...
	protected void init() {
		...
		this.rise = HeroRise.create(this);
		if(heroEntity.getState()>0){
			this.state = PBHeroState.valueOf(heroEntity.getState());
		}
		checkColorUp();
	}
