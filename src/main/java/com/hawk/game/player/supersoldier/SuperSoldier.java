...
public class SuperSoldier {
	...
	private PBSuperSoldierState state = PBSuperSoldierState.SUPER_SOLDIER_STATE_FREE;
...
//		}
	...
	protected void init() {
		...
		if(superSoldierEntity.getState()>0){
			this.state = PBSuperSoldierState.valueOf(superSoldierEntity.getState());
		}
	}
