...
public class PlayerTickTimeLine {
	...
	private long lastCalcStrengthPoint;
	/**
	 * 预流失活动
	 */
	...
	public long getLastCalcStrengthPoint() {
		return lastCalcStrengthPoint;
	}
	
	public void setLastCalcStrengthPoint(long lastCalcStrengthPoint) {
		this.lastCalcStrengthPoint = lastCalcStrengthPoint;
	}
