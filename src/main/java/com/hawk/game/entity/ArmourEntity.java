...
public class ArmourEntity extends HawkDBEntity {
	 ...
	 * 不朽熔铸
	 */
	@Column(name = "immortInfo")
	@IndexProp(id = 19)
	private String immortInfo;
	 ...
	 */
	@Transient
	private ArmourImmortComp immortComp;
	...
	public void beforeWrite() {
		...
		if (immortComp != null) {
			immortInfo = immortComp.serialize();
		} else {
			immortInfo = "";
		}
	}
	...
	public void afterRead() {
		...
		immortComp = ArmourImmortComp.create(this);
	}
	...
	public ArmourImmortComp getImmort() {
		if(immortComp==null){
			immortComp = ArmourImmortComp.create(this);
		}
		return immortComp;
	...
	public void setImmort(ArmourImmortComp immortComp) {
		this.immortComp = immortComp;
	}
