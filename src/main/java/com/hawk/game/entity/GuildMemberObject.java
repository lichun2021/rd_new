...
//		}
	...
	public long getStrengthPower(){
		if(this.entity.getStrengthPower() > 0){
			return this.entity.getStrengthPower();
		}
		Player player = GlobalData.getInstance().getActivePlayer(entity.getPlayerId());
		long strengthPower = player.getStrength();
		this.entity.setStrengthPower(strengthPower);
		return strengthPower;
	}
	
	public void updateStrengthPower(long strengthPower){
		this.entity.setStrengthPower(strengthPower);
	}
}
