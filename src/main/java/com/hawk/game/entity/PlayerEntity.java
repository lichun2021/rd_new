...
public class PlayerEntity extends HawkDBEntity {
	 ...
	 * 是否是鸿蒙玩家
	 */
	@Column(name = "openharmony")
	@IndexProp(id = 56)
	private String openharmony = "";
	...
	public String getOpenharmony() {
		return openharmony;
	}

	public void setOpenharmony(String openharmony) {
		this.openharmony = openharmony;
	}
}