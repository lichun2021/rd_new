...
public class CommanderEntity extends HawkDBEntity {
	...
	@Column(name = "riseSkillSettings")
	@IndexProp(id = 15)
	private String riseSkillSettings;

	@Column(name = "immortEcho")
	@IndexProp(id = 16)
	private String immortEcho;
	...
	@Transient
	private RiseSkillSettings riseSettings = new RiseSkillSettings();
	// 通知指挥官信息变更
	@Transient
	...
	public void beforeWrite() {
		if (commanderObject != null) {
			...
			this.immortEcho = commanderObject.serializeImmort();
		}
		this.changed = false;
		...
		if(this.riseSettings!=null){
			this.riseSkillSettings = riseSettings.serializ();
		}
		super.beforeWrite();
	}
	...
	public void afterRead() {
		...
		this.riseSettings = new RiseSkillSettings();
		riseSettings.mergeFrom(riseSkillSettings);
		super.afterRead();
	}
	...
	public String getRiseSkillSettings() {
		return riseSkillSettings;
	}

	public void setRiseSkillSettings(String riseSkillSettings) {
		this.riseSkillSettings = riseSkillSettings;
	}

	public RiseSkillSettings getRiseSettings() {
		return riseSettings;
	}

	public String getImmortEcho() {
		return immortEcho;
	}
}
