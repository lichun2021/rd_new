...
public class HeroEntity extends HawkDBEntity {
	...
	@Column(name = "riseSerialized")
	@IndexProp(id = 23)
	private String riseSerialized="";
	...
	public void beforeWrite() {
		if (null != heroObj) {
			...
			this.riseSerialized = heroObj.getRise().serializ();
		}
		this.changed = false;
		super.beforeWrite();
	}
	...
	public String getRiseSerialized() {
		return riseSerialized;
	}

	public void setRiseSerialized(String riseSerialized) {
		this.riseSerialized = riseSerialized;
	}
