...
public class SWWorldPointService {
	...
	public void addViewPoint(ISWWorldPoint point) {
		...
		getWorldScene().addViewPoint(point);
	...
	public boolean removeViewPoint(ISWWorldPoint vp) {
		...
		// 移除世界场景
		getWorldScene().removeViewPoint(vp);
	...
	private void doUpdateWorldPoint(ISWWorldPoint point, boolean delete) {
		worldScene.updateViewPoint(point, delete);
	}
	...
	private void initWorldScene() {
		// 初始化世界场景
		worldScene = new SWWorldScene(worldMaxX, worldMaxY);
	}
