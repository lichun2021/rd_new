...
import com.hawk.game.invoker.GuildActiveRankUpdateInvoker;
...
public class RankService extends HawkAppObj {
	 ...
	 * 联盟活跃度榜
	 */
	private GuildActiveRankObject guildActiveRankObject = null;
	/**
	 * 获取实体对象
	 * 
	 * @return
	...
	private void initGuildActiveRank() {
		this.guildActiveRankObject = new GuildActiveRankObject();
		this.guildActiveRankObject.init();
		long rankRefreshTime = TimeUnit.HOURS.toMillis(GuildConstProperty.getInstance().getAllianceActivityRankRefresh());
		this.addTickable(new HawkPeriodTickable(rankRefreshTime, rankRefreshTime) {
			@Override
			public void onPeriodTick() {
				guildActiveRankObject.loadCacheRank();
	...
	public GuildActiveRankObject getGuildActiveRankObject() {
		return guildActiveRankObject;
	}

	public void updateActiveRankScore(String guildId, long incrementScore) {
		this.dealMsg(GameConst.MsgId.UPDATE_GUILD_ACTIVE_VALUE_RANK, new GuildActiveRankUpdateInvoker(guildId, incrementScore));
	}
	/**
