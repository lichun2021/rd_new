...
public class YQZZGameData implements IYQZZData{
	...
	private static final String redisKey = "YQZZ_ACTIVITY_GAME_DATA_20251211";
	...
	public void addGuild(String serverId){
		if(this.guilds.contains(serverId)){
			return;
		}
		this.guilds.add(serverId);
	}
	
	public void addGuild(List<String> serverIds){
		for(String serverId: serverIds){
			this.addGuild(serverId);
		}
	}
	...
	public void mergeFrom(String serialiedStr) {
		...
		String serverStr = obj.getString("guilds");
