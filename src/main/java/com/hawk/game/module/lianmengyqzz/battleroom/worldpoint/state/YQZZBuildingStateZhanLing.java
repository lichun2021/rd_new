...
public class YQZZBuildingStateZhanLing extends IYQZZBuildingState {
	...
	private void addHonor(long timePass) {
		...
		buildingHonor.setGuildHonor(Math.ceil(buildingHonor.getControlTime() * 0.001 * getParent().getGuildHonorPerSecond()));
		buildingHonor.setNationHonor(Math.ceil(buildingHonor.getControlTime() * 0.001 * getParent().getNationHonorPerSecond()));
		buildingHonor.setPlayerHonor(Math.ceil(buildingHonor.getControlTime() * 0.001 * getParent().getPlayerHonorPerSecond()));
