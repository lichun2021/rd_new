...
public class YQZZConst {
	...
	public enum YQZZActivityState{
		...
		public static YQZZActivityState getNext(YQZZActivityState state){
			switch (state) {
			case HIDDEN:return START_SHOW;
			case START_SHOW:return MATCH;
			case MATCH:return BATTLE;
			case BATTLE:return REWARD;
			case REWARD:return END_SHOW;
			case END_SHOW:return HIDDEN;
			default:return null;
			}
		}
