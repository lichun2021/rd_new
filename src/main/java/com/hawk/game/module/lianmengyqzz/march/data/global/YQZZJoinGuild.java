...
public class YQZZJoinGuild  implements IYQZZData{
	...
	private static final String redisKey = "YQZZ_ACTIVITY_JOIN_GUILD_20251211";
	...
	public String serializ() {
		...
		obj.put("nationLevel", this.nationLevel);
		...
		obj.put("openDays", this.openDays);
		...
		if(this.freePlayers!= null && !this.freePlayers.isEmpty()){
			for(Map.Entry<String, Integer> entry : this.freePlayers.entrySet()){
				...
				arrfree.add(entryObj.toJSONString());
			}
		}
	...
	public void mergeFrom(String serialiedStr) {
		...
		this.nationLevel = obj.getIntValue("nationLevel");
		...
		this.openDays = obj.getIntValue("openDays");
	...
	public static Map<String,YQZZJoinGuild> loadAllData(int termId,Set<String> guilds){
		String key = redisKey  + ":" + termId;
	...
	public static Map<String,YQZZJoinGuild> loadAllData(int termId){
		String key = redisKey  + ":" + termId;
		Map<String,YQZZJoinGuild> rlt = new HashMap<>();
