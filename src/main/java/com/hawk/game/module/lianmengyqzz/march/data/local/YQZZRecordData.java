...
public class YQZZRecordData  implements IYQZZData{
	...
	private static final String redisKey = "YQZZ_ACTIVITY_AWARD_RECORD_DATA_20251211";
	...
	public static YQZZRecordData loadData(String guildId,int termId){
	...
	public static Map<Integer,YQZZRecordData> loadAll(String guildId,List<Integer> terms){
		String key = redisKey  + ":" + guildId;
