...
public class YQZZBuildingHonor {
	...
	private double allianceLastScore;
	...
	public PBYQZZBuildHonor toPBObj() {
		...
		builder.setGuildHonor((int) (guildHonor + firstControlGuildHonor + allianceLastScore));
	...
	public double getAllianceLastScore() {
		return allianceLastScore;
	}

	public void setAllianceLastScore(double allianceLastScore) {
		this.allianceLastScore = allianceLastScore;
	}
