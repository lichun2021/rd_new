...
//		}
		...
		CustomDataEntity customData = player.getData().getCustomDataEntity(CustomKeyConst.FAKE_MONSTER_KILL_TIMES);
		if (customData == null) {
			customData = player.getData().createCustomDataEntity(CustomKeyConst.FAKE_MONSTER_KILL_TIMES, 0, "");
		}
