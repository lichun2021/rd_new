...
public class PlantScience {
	 ...
	 * @return
	 */
	public boolean techLevelUp(int techId, int multiLevel) {
		...
		int afterLvl = beforeLvl + multiLevel;
		...
		//Tlog
		LogUtil.logPlantScienceResearchOperation(this.getParent(), techId, afterLvl, 2, getTechPower(), multiLevel);
		return true;
	}
