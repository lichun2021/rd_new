...
public abstract class IXQHXPlayer extends Player implements IXQHXWorldPoint {
	...
	private ConcurrentHashSet<Integer> inviewPoints = new ConcurrentHashSet<>();
	/** 城点 */
	private int[] pos = { 0, 0 };
	/** 下次可免费迁城时间 */
...
//		}
		...
		builder.setEquipImmortEchoShow(WorldPointService.getInstance().getEquipImmortShow(getId()));
...
//		}
	...
	public ConcurrentHashSet<Integer> getInviewPoints() {
		return inviewPoints;
	}
	public void setInviewPoints(ConcurrentHashSet<Integer> inviewPoints) {
		this.inviewPoints = inviewPoints;
	}
