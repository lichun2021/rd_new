...
public abstract class IXQHXBuilding implements IXQHXWorldPoint {
	...
	@Override
	public WorldPointPB.Builder toBuilder() {
		...
		List<IXQHXWorldMarch> stayMarches = getParent().getPointMarches(getPointId(), WorldMarchStatus.MARCH_STATUS_MARCH_QUARTERED);
		for (IXQHXWorldMarch march : stayMarches) {
			stayArmycount += march.getMarchEntity().getArmyCount();
		}
	...
	public void onMarchReach(IXQHXWorldMarch leaderMarch) {
		...
		final long start = HawkTime.getMillisecond();
		...
		final long step1 = HawkTime.getMillisecond() - start;
		// 防守方玩家
		...
		final long step2 = HawkTime.getMillisecond() - start;
		...
		final long step3 = HawkTime.getMillisecond() - start;
		...
		final long step4 = HawkTime.getMillisecond() - start;
		...
		final long step5 = HawkTime.getMillisecond() - start;
		...
		final long step6 = HawkTime.getMillisecond() - start;
		...
		final long step7 = HawkTime.getMillisecond() - start;
		...
		final long step8 = HawkTime.getMillisecond() - start;
		if(step8 > 1000){
			DungeonRedisLog.log(getParent().getId(), "start: {},  step1: {}, step2: {}, step3: {}, step4: {}, step5: {}, step6: {}, step7: {}, step8: {}", order10001DebuffCamp
					,HawkTime.formatTime(start), step1, step2, step3, step4, step5, step6, step7, step8);
		}
	}
	
	public void listMail(IXQHXPlayer player, int type) {
		...
		resp.addList(bul);
		player.sendProtocol(HawkProtocol.valueOf(HP.code2.XQHX_ANCHOR_LIST_MAIL_S, resp));
	}
