...
public class HomeLandPlayerRankInfo implements SplitEntity {
    ...
    public HomeLand.HomeLandRankMsg.Builder buildRankInfo(HomeLandRank homeLandRank) {
        ...
        rankInfo.setNpcNum(getNpcNum());
        rankInfo.setRankTime(homeLandRank.getRankTime());
        return rankInfo;
    }
