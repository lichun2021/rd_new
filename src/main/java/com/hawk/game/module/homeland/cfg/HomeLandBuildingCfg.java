...
public class HomeLandBuildingCfg extends HawkConfigBase {
    ...
    private final String buildRecovery;
    ...
    protected List<ItemInfo> resolveItems;

    private static Map<Integer, Integer> maxLevelType = new HashMap<>();
    ...
    protected boolean assemble() {
        ...
        resolveItems = ItemInfo.valueListOf(buildRecovery);
        maxLevelType.merge(buildType, buildLevel, Math::max);
        return true;
    }
    ...
    protected boolean checkValid() {
        HomeLandBuildingTypeCfg typeCfg = HawkConfigManager.getInstance().getConfigByKey(HomeLandBuildingTypeCfg.class,
                buildType);
        if (typeCfg == null) {
    ...
    public static int getMaxLevel(int buildType) {
        return maxLevelType.getOrDefault(buildType, 0);
    }

    public String getBuildRecovery() {
        return buildRecovery;
    }

    public List<ItemInfo> getResolveItems() {
        return resolveItems;
    }
}
