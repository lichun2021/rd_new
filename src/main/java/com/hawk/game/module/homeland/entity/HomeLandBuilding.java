...
public class HomeLandBuilding implements IHomeLandPoint {
    ...
    private long lastHarvestRes; //上次收取资源的数量
    ...
    public HomeLandBuildingPB toPB() {
        ...
        builder.setHarvestRes(lastHarvestRes);
    ...
    public long getLastHarvestRes() {
        return lastHarvestRes;
    }

    public void setLastHarvestRes(long lastHarvestRes) {
        this.lastHarvestRes = lastHarvestRes;
    }
}
