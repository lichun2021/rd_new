...
public class NationalHospitalModule extends PlayerModule {
    ...
    private int getHospitalAcceptDeadLimit() {
    	...
    	int limitCount = hospitalCfg.getHospitalLimit();
    	int eff1268 = this.player.getEffect().getEffVal(EffType.EFF_NATION_HOSPITAL_COUNT_1268);
    	limitCount = limitCount + eff1268;
    	limitCount += player.getEffect().getEffVal(EffType.EFF_10095);
    	return limitCount;
    }
