...
public class PfOnlineInfo {
	 ...
	 * 鸿蒙玩家在线人数
	 */
	private AtomicInteger harmonyOnlineCount = new AtomicInteger(0);
	...
	public int addHarmonyOnline() {
		return harmonyOnlineCount.incrementAndGet();
	}
	...
	public int removeHarmonyOnline() {
		return harmonyOnlineCount.decrementAndGet();
	}
	...
	public int getHarmonyOnlineCnt() {
		return harmonyOnlineCount.get();
	}
