...
public class TBLYSeasonPlayerData {
    ...
    public int getEliminationZone() {
		return eliminationZone;
	}
    
    public void setEliminationZone(int eliminationZone) {
		this.eliminationZone = eliminationZone;
	}
