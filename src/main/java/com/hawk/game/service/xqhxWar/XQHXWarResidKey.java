...
public class XQHXWarResidKey {
    ...
    // --------------------------------联赛相关---------------------------------------------
    public static final String XQHX_WAR_NO_MATCH = "XQHX_WAR:NO_MATCH:%d";

    public static final String XQHX_WAR_TEST_GUILD = "XQHX_WAR:TEST:GUILD";
    public static final String XQHX_WAR_TEST_TEAM = "XQHX_WAR:TEST:TEAM";
}
