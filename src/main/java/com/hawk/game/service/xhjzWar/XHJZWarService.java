...
public class XHJZWarService extends HawkAppObj {
	...
	public String selectRoomServer(Map<String, Integer> roomServerMap, XHJZWarTeamData teamData1, XHJZWarTeamData teamData2) {
		...
		try {
			...
			HawkLog.logPrintln("XHJZWarService-selectRoomServer-ONE-{},{},{}",teamData1.id,teamData2.id,rlt);
		} catch (Exception e) {
			rlt = teamData1.serverId.compareTo(teamData2.serverId) >= 0 ? teamData1.serverId : teamData2.serverId;
			HawkLog.logPrintln("XHJZWarService-selectRoomServer-TWO-{},{},{}",teamData1.id,teamData2.id,rlt);
		}
		return rlt;
	}
    ...
    public void onBattleOpen(int timeIndex){
        ...
        //推送
        XHJZWarOpenPushTask.addPushEvnet(timeIndex, roomIds, roomDataMap);
    }
