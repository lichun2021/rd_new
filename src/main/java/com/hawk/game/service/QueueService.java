...
public class QueueService {
	...
	public QueueEntity addReusableQueue(Player player, int queueType, int queueStatus, String itemId, int buildType, 
		...
		HawkLog.logPrintln("add queue, playerId: {}, queueType: {}, queueStatus: {}, itemId: {}, costtime: {}, cancelBackRes: {}, multiply:{}", player.getId(), queueType, queueStatus, itemId, String.valueOf(costtime), cancelBackRes, multiply);
	...
	private HawkMsg createFinishMsg(Player player, QueueEntity queueEntity, boolean isImmediate) {
		...
		case QueueType.SCIENCE_QUEUE_VALUE:
			return TechQueueFinishMsg.valueOf(Integer.parseInt(queueEntity.getItemId()), queueEntity.getMultiply());
		...
		case QueueType.CROSS_TECH_QUEUE_VALUE:
			return CrossTechQueueFinishMsg.valueOf(Integer.parseInt(queueEntity.getItemId()), queueEntity.getMultiply());
		...
		case QueueType.PLANT_SCIENCE_QUEUE_VALUE:
			return PlantScienceQueueFinishMsg.valueOf(Integer.parseInt(queueEntity.getItemId()), queueEntity.getMultiply());
