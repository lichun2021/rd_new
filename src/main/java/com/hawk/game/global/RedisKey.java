...
public class RedisKey {
	...
	/**
	 * 玩家数据存储key（一般用于跨服传输数据）
	 */
	public static final String PLAYER_DATA_KEY = "player_data:";
	public static final String ENTITY_STATUS_KEY = "entity_status:";
	
	/**
	 * 活动数据存储key（一般用于迁服中转数据）
	 */
	public static final String PLAYER_ACTIVITY_KEY = "player_data_activity:";

	/**
	 * 家园排行榜npc交互红点
	 */
	public static final String HOME_LAND_NPC_RED = "HOME_LAND_NPC:RED_DOT:";
	/**
	 * 玩家活跃统计信息
	 */
	public static final String PLAYER_ACTIVE_STAT_INFO = "player_activestat_info:";
