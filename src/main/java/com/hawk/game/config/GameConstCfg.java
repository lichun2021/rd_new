...
public class GameConstCfg extends HawkConfigBase {
	 ...
	 * 7周年聚会活动
	 */
	private final String ann7ServerGroup;
	private List<String> ann7ServerGroupList = new ArrayList<>();
	...
	protected boolean assemble() {
		...
		ann7ServerGroupList = SerializeHelper.stringToList(String.class, ann7ServerGroup, ",");
		
		instance = this;
		return true;
	}
	
	public List<String> getAnn7ServerGroupList() {
		return ann7ServerGroupList;
	}
