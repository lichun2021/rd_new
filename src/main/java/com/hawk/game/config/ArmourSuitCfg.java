...
public class ArmourSuitCfg extends HawkConfigBase {
	 ...
	 * 两件套激活量子属性
	 */
	protected final String suitImmortAttr1;

	/**
	 * 四件套激活量子属性
	 */
	protected final String suitImmortAttr2;

	/**
	 * 六件套激活量子属性
	 */
	protected final String suitImmortAttr3;

	/**
	 * 七件套激活量子属性
	 */
	protected final String suitImmortAttr4;
	/**
	 * 两件套激活属性
	 */
	...
	private List<EffectObject> suitImmortEff1;
	private List<EffectObject> suitImmortEff2;
	private List<EffectObject> suitImmortEff3;
	private List<EffectObject> suitImmortEff4;
	...
	public List<EffectObject> getSuitImmortEff1() {
		return suitImmortEff1;
	}

	public List<EffectObject> getSuitImmortEff2() {
		return suitImmortEff2;
	}

	public List<EffectObject> getSuitImmortEff3() {
		return suitImmortEff3;
	}

	public List<EffectObject> getSuitImmortEff4() {
		return suitImmortEff4;
	}
	...
	protected boolean assemble() {
		...
		this.suitImmortEff1 = SerializeHelper.stringToList(EffectObject.class, suitImmortAttr1, SerializeHelper.BETWEEN_ITEMS, SerializeHelper.ATTRIBUTE_SPLIT, new ArrayList<>());
		this.suitImmortEff2 = SerializeHelper.stringToList(EffectObject.class, suitImmortAttr2, SerializeHelper.BETWEEN_ITEMS, SerializeHelper.ATTRIBUTE_SPLIT, new ArrayList<>());
		this.suitImmortEff3 = SerializeHelper.stringToList(EffectObject.class, suitImmortAttr3, SerializeHelper.BETWEEN_ITEMS, SerializeHelper.ATTRIBUTE_SPLIT, new ArrayList<>());
		this.suitImmortEff4 = SerializeHelper.stringToList(EffectObject.class, suitImmortAttr4, SerializeHelper.BETWEEN_ITEMS, SerializeHelper.ATTRIBUTE_SPLIT, new ArrayList<>());
