 ...
 * @since 2025-09-24
 */
@HawkConfigManager.XmlResource(file = "xml/battle2025ValueSoldier.xml")
public class Battle2025ValueSoldierCfg extends HawkConfigBase {
   ...
   // assemble fields define end
    ...
    public Battle2025ValueSoldierCfg() {
