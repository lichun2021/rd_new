...
@HawkConfigManager.XmlResource(file = "xml/xqhx_league_target_reward.xml")
public class XQHXSeasonTargetRewardCfg extends HawkConfigBase {
    /** 活动期数*/
    @Id
    ...
    public XQHXSeasonTargetRewardCfg(){
        id = 0;
        type = 0;
        target = 0;
        reward = "";
