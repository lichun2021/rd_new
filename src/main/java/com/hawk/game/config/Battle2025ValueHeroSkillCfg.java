 ...
 * @since 2025-09-24
 */
@HawkConfigManager.XmlResource(file = "xml/battle2025ValueHeroSkill.xml")
public class Battle2025ValueHeroSkillCfg extends HawkConfigBase {
   ...
   // assemble fields define end
    ...
    public Battle2025ValueHeroSkillCfg() {
