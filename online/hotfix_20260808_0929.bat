...
echo    Changed classes: 19
echo ====================================
echo.

rem Check port parameter
if "%~1"=="" (
    echo Usage: hotfix_20260808_0929.bat [port]
    echo Example: hotfix_20260808_0929.bat 8080
    echo.
    pause
    exit /b 1
)
...
timeout /t 1 /nobreak >nul 
echo. 
echo [hotfix] com.hawk.game.battle.effect.impl.hero1116.Hero1116Param 
call .\hotfix-class.bat com.hawk.game.battle.effect.impl.hero1116.Hero1116Param %PORT% 
timeout /t 1 /nobreak >nul 
echo. 
...
timeout /t 1 /nobreak >nul 
echo. 
echo [hotfix] com.hawk.game.crossproxy.CrossProxyHealth 
call .\hotfix-class.bat com.hawk.game.crossproxy.CrossProxyHealth %PORT% 
timeout /t 1 /nobreak >nul 
echo. 
